...
1. Return to **Power BI Desktop** and open the **Item Sales Report** if it is not already open.
...
1. Open the enhanced **Item Sales Report** in the **Power BI Service** (Copilot is also available in Power BI Desktop if enabled in your environment).
